![Glienicker Brücke](Glienicker_Brücke.jpg "Glienicker Brücke")
...
I work as a software architect at [\]init\[ AG](https://www.init.de/en). Before that, I developed a cloud-based practice management system for psychotherapists together with my team at [Epikur GmbH](https://www.epikur.de/). And for over 10 years, I was head of development for the [open source project verinice](https://verinice.com/en/) at [SerNet GmbH](https://www.sernet.de/en/). Verinice is a platform for managing information security and data protection. 
...
_(Photo: [Glienicker Bridge](https://en.wikipedia.org/wiki/Glienicke_Bridge) over the Havel between Berlin and Potsdam)_
